...
from . import custom_sampler as s
...
class MF():
    ...
    def __init__(self, data, factors,lr,reg,seed, *args, **kwargs):
        ...
        # self._sampler = s.Sampler(self._data.i_train_dict, self._m, self._data.sp_i_train, self._seed)
